...
public void createGUI(){
  ...
  lblBluePercentData = new GLabel(this, 170, 110, 80, 20);
  ...
  lblTemperatureData = new GLabel(this, 120, 190, 80, 20);
  lblTemperatureData.setText("N/A");
  lblTemperatureData.setOpaque(false);
  lblLEDCurrent = new GLabel(this, 10, 210, 110, 20);
  ...
  lblLEDCurrentData = new GLabel(this, 120, 210, 80, 20);
  lblLEDCurrentData.setText("N/A");
  lblLEDCurrentData.setOpaque(false);
  lblDACSetting = new GLabel(this, 10, 230, 110, 20);
  ...
  lblAveragingData = new GLabel(this, 120, 270, 80, 20);
  lblAveragingData.setText("N/A");
  lblAveragingData.setOpaque(false);
  lblTriggering = new GLabel(this, 10, 290, 110, 20);
  ...
  lblTriggeringData = new GLabel(this, 120, 290, 80, 20);
  lblTriggeringData.setText("N/A");
  lblTriggeringData.setOpaque(false);
  lblOutputDelay = new GLabel(this, 10, 310, 110, 20);
  ...
  lblOutputDelayData = new GLabel(this, 120, 310, 80, 20);
  lblOutputDelayData.setText("N/A");
  lblOutputDelayData.setOpaque(false);
  lblIllumination = new GLabel(this, 10, 330, 110, 20);
  ...
  lblFirmwareVersionData = new GLabel(this, 320, 230, 80, 20);
  lblFirmwareVersionData.setText("N/A");
  lblFirmwareVersionData.setOpaque(false);
  btnUpdateData = new GButton(this, 10, 60, 240, 20);
  ...
  lblLedStability = new GLabel(this, 10, 250, 110, 20);
  ...
  lblLedStabilityData = new GLabel(this, 120, 250, 80, 20);
  ...
  txtRedGreenBlue = new GTextField(this, 110, 160, 140, 20, G4P.SCROLLBARS_NONE);
  txtRedGreenBlue.setOpaque(true);
  txtRedGreenBlue.addEventHandler(this, "txtRedGreenBlue_change1");
  lblCopyableRGB = new GLabel(this, 10, 160, 100, 20);
  ...
  btnStart = new GButton(this, 10, 360, 480, 40);
  ...
  btnStop = new GButton(this, 10, 410, 480, 40);
  btnStop.setText("Stop Test");
  btnStop.setTextBold();
  btnStop.setLocalColorScheme(GCScheme.RED_SCHEME);
  btnStop.addEventHandler(this, "btnStop_click1");
  lblTestStartedLabel = new GLabel(this, 10, 460, 170, 20);
  lblTestStartedLabel.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
  lblTestStartedLabel.setText("Test started at:");
  lblTestStartedLabel.setTextBold();
  lblTestStartedLabel.setOpaque(false);
  lblSecondsPassedLabel = new GLabel(this, 10, 480, 170, 20);
  lblSecondsPassedLabel.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
  lblSecondsPassedLabel.setText("Seconds passed since start:");
  lblSecondsPassedLabel.setTextBold();
  lblSecondsPassedLabel.setOpaque(false);
  lblTestStarted = new GLabel(this, 180, 460, 310, 20);
  lblTestStarted.setText("N/A");
  lblTestStarted.setOpaque(false);
